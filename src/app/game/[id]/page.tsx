...
export default function SafePlayerParamPage({
  ...
  // Sync state parameters linked to host timing layout
  ...
  // Local clock accurately following host pacing matrices
  useEffect(() => {
    if (gamePhase !== 'quiz' || hasAnswered) return

    // 4-Second Intro Delay matching host screen exactly
    let introTime = 4
